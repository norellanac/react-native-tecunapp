          ...
          <Form style={{ marginRight: 45, marginLeft: 45, marginTop: 20 }}>
            <Item rounded style={{ marginTop: 25 }}>
              ...
              <Input
                ...
                style={{ color: "#000000" }}
              />
              <Button transparent onPress={() => this.searchStores(this.state.search, this.props.usuariosReducer.token)}>
...
export default withNavigation(
  connect(mapStateToProps, mapDispatchProps)(StoreShowScreen)
);