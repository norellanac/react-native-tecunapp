...
class PodcastShowScreen extends Component {
  ...
  loadInfoComment() {
    ...
    if (
      this.props.podcastReducer.podcast.comments &&
    ...
    await sound.loadAsync(
      {
        uri:
          ...
          this.props.podcastReducer.podcast.featured_audio,
      },
      { shouldPlay: false }
    );
  ...
  inputSpotify() {
    if (
      this.props.podcastReducer.podcast.featured_spotify &&
      this.state.showSpotify == true
    ) {
      return (
        <WebView
          source={{
            html: `<iframe src="${this.props.podcastReducer.podcast.featured_spotify}" width="100%" height="100%" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>`,
          }}
      ...
      return (
          <CardItem>
            <Left>
              ...
              >
                <Icon name="play-circle" type="FontAwesome5"></Icon>
                <Text>Play</Text>
              </Button>
            </Left>
            <Body>
              ...
              >
                <Icon name="pause-circle" type="FontAwesome5"></Icon>
                <Text>Pause</Text>
              </Button>
            </Body>
            <Right>
              ...
              >
                <Icon name="stop-circle" type="FontAwesome5"></Icon>
                <Text>Stop</Text>
              </Button>
            </Right>
          </CardItem>
  ...
  render() {
    ...
    if (
      this.props.podcastReducer.cargando ||
      this.props.podcastReducer.podcast.comments == undefined
    ) {
      return (
        <Container>
                  ...
                  if (podcast.featured_audio) {
                    return (
                      <Button
                        ...
                        onPress={() =>
                          Linking.openURL(
                            this.state.pathImage + podcast.featured_audio
                          )
                        }
                      >
